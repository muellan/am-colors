...
" #3296F0 #87AFD7 #68ABDD #70D0E5 #80F0FF #A5F5FF #DCFAFF #506080 #6E7D82
" #B0A0FF #B8A0E9 #D5C5FF #E0D5FF                 #505080 #68539F
" #20FF10 #00FFAF #99FF6B #96F032 #B6F22E #B4E05A #C0E080 #50DC82 #66D066 #205020 #80A060 #D2F0CA
...
hi Visual            guifg=#D0D0CC guibg=#606050
...
hi TabLineFill       guifg=#303028 guibg=#282826          cterm=NONE
hi TabLine           guifg=#A5A5A2 guibg=#282826 gui=NONE cterm=NONE
...
hi EndOfBuffer       guifg=#414237               gui=NONE
...
hi DiffTextAdd                     guibg=#207020

hi MatchParen        guifg=#000000 guibg=#FD971F gui=bold
hi MatchError        guifg=#FFFFFF guibg=#F02000
hi MatchWord         guifg=#000000 guibg=#FD971F gui=bold

hi Tag               guifg=#B8A0E9               gui=italic cterm=italic
hi Title             guifg=#FF7030               gui=bold
hi Todo              guifg=bg      guibg=#A09B6B gui=bold

hi Directory         guifg=#87AFD3               gui=bold
...
hi PmenuMatch        guifg=#000000 guibg=#FFF5A5 
hi PmenuMatchSel     guifg=#000000 guibg=#FFF5A5  
" hi PmenuKind       
" hi PmenuKindSel    
" hi PmenuExtra       
" hi PmenuExtraSel     
...
if has("spell")
    hi SpellBad      guifg=NONE guibg=NONE guisp=#FF7030 gui=undercurl 
    hi SpellCap      guifg=NONE guibg=NONE guisp=#D5C5FF gui=undercurl
    hi SpellLocal    guifg=NONE guibg=NONE guisp=#70D0E5 gui=undercurl
    hi SpellRare     guifg=NONE guibg=NONE guisp=#FFA546 gui=undercurl
    " hi SpellBad      guisp=#FF7030 gui=undercurl ctermfg=210  ctermbg=52  ctermul=210 cterm=undercurl
    " hi SpellCap      guisp=#D5C5FF gui=undercurl ctermfg=189  ctermbg=59  ctermul=135 cterm=undercurl
    " hi SpellLocal    guisp=#70D0E5 gui=undercurl ctermfg=195  ctermbg=17  ctermul=39  cterm=undercurl
    " hi SpellRare     guisp=#FFA546 gui=undercurl ctermfg=229  ctermbg=58  ctermul=172 cterm=undercurl
endif
...
" plugins {{{
"--------------------------------------------------------------------
hi CleverF     guifg=#000000 guibg=#FFA0FF gui=bold
...
" EasyTree
hi EasyTreeRoot              guifg=#70D0E5  gui=bold cterm=bold
hi EasyTreeRootUp            guifg=#87AFD7  gui=bold cterm=bold
hi EasyTreeDir               guifg=#87AFD7  gui=bold cterm=bold
hi EasyTreeDirArrow          guifg=#70D0E5  gui=bold cterm=bold
hi EasyTreeGitBranch         guifg=#D7D7FF  gui=bold cterm=bold
hi EasyTreeGitStaged         guifg=#D2F0CA
hi EasyTreeGitUnstaged       guifg=#D2F0CA
hi EasyTreeGitSeparator      guifg=#858575
hi EasyTreeGitAdded          guifg=#FAEA70
hi EasyTreeGitModified       guifg=#FAEA70
hi EasyTreeGitRenamed        guifg=#DCFAFF
hi EasyTreeGitCopied         guifg=#DCFAFF
hi EasyTreeGitDeleted        guifg=#FF8080
hi EasyTreeGitUnmerged       guifg=#D7D7FF
hi EasyTreeGitUntracked      guifg=#C0E080
hi link EasyTreeGitIgnored   Comment
hi link EasyTreeGitUnknown   Comment
hi EasyTreeFile              guifg=#E4E4E4
hi EasyTreeFileCpp           guifg=#E0F8D0
hi EasyTreeFileHpp           guifg=#E0F0E0
hi EasyTreeFileJSON          guifg=#EFEFBA
hi EasyTreeFileJS            guifg=#C0E0F0
hi EasyTreeFileVIM           guifg=#E0D0F0
hi EasyTreeFileMarkdown      guifg=#F0D0C0
hi EasyTreeFilePython        guifg=#E0F0B0
hi EasyTreeFileOffice        guifg=#C0D0F0
hi EasyTreeFileMarkup        guifg=#F0F0B0
hi EasyTreeFileStyleSheet    guifg=#F0F0B0
hi EasyTreeFileShellScript   guifg=#E0F0C0
hi EasyTreeFileImage         guifg=#F0CAB0
hi EasyTreeFileVectorImage   guifg=#F0D5B0
hi EasyTreeFileAudio         guifg=#F0D0E0
hi EasyTreeFileVideo         guifg=#F0E0F0
hi EasyTreeFileHTML          guifg=#E0F0F0
hi EasyTreeFileMarkup        guifg=#F0F0D0
hi EasyTreeFileStyleSheet    guifg=#F0D0F0

" NERD Tree
hi NERDTreeOpenBuffer guifg=#202018 guibg=#FFF5A5 gui=bold
...
" signature
hi SignatureMarkText   guifg=#000000 guibg=#B4E05A gui=NONE
...
" hi ALEError               guifg=#FF8080 guibg=#600000 guisp=#FF7030 gui=undercurl ctermfg=210  ctermbg=52  ctermul=210  cterm=undercurl
" hi ALEWarning             guifg=#FFFF80 guibg=#606000 guisp=#FFC546 gui=undercurl ctermfg=228  ctermbg=58  ctermul=228  cterm=undercurl
" hi ALEInfo                guifg=#A0FFFF guibg=#000060 guisp=#70D0E5 gui=undercurl ctermfg=159  ctermbg=17  ctermul=159  cterm=undercurl

hi ALEError               guifg=NONE guibg=NONE guisp=#FF7030 gui=undercurl ctermul=210  cterm=undercurl
hi ALEWarning             guifg=NONE guibg=NONE guisp=#FFC546 gui=undercurl ctermul=228  cterm=undercurl
hi ALEInfo                guifg=NONE guibg=NONE guisp=#70D0E5 gui=undercurl ctermul=159  cterm=undercurl
...
hi LspDiagVirtualText    guifg=#A09E95 guibg=NONE    gui=NONE
hi LspTextRef            guifg=NONE    guibg=#454865 gui=NONE
hi LspReadRef            guifg=#D2F0CA guibg=#406020 gui=NONE
hi LspWriteRef           guifg=#FFF0E0 guibg=#604020 gui=NONE
hi LspInlayHintsType     guifg=#809AA0 guibg=NONE    gui=NONE
hi LspInlayHintsParam    guifg=#859085 guibg=NONE    gui=NONE
hi LspSigActiveParameter guifg=#000000 guibg=#BEBEAA gui=NONE
...
hi NeoDbgBreakPoint      guifg=NONE    guibg=#B03030
hi NeoDbgDisabledBreak   guifg=NONE    guibg=#603020
...
hi GitGutterAddLineNr             guibg=#205020
hi GitGutterChangeLineNr          guibg=#605020
hi GitGutterChangeDeleteLineNr    guibg=#604020
hi GitGutterDeleteLineNr          guibg=#603020
...
hi VM_Extend  guifg=NONE     guibg=#505080  gui=NONE
hi VM_Cursor  guifg=#000000  guibg=#B0A0FF  gui=NONE
hi VM_Mono    guifg=#000000  guibg=#60A0F0  gui=NONE
hi VM_Insert  guifg=#000000  guibg=#FFA546  gui=NONE
...
hi Boolean           guifg=#B8A0E9 guibg=NONE gui=italic cterm=italic
...
hi Namespace         guifg=#6E7D82 guibg=NONE gui=italic cterm=italic

hi Enumeration       guifg=#70D0E5 guibg=NONE gui=bold
hi Enumerator        guifg=#50DC82 guibg=NONE gui=italic cterm=italic
...
hi def      cppDoxygenTag        guifg=#A09B6B guibg=bg      gui=bold
...
if &t_Co > 255
  ...
  hi Boolean                   ctermfg=111  ctermbg=NONE    cterm=italic

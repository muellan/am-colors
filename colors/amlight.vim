...
" plugins {{{  
"--------------------------------------------------------------------
hi CleverF     guifg=#FFFFFF guibg=#A000A0 gui=bold     
...
" signature
hi SignatureMarkText   guifg=#FFFFFF guibg=#20B020 gui=NONE
...
hi Boolean           guifg=#8040B0 guibg=NONE gui=italic cterm=italic
hi Character         guifg=#D06020 guibg=NONE
hi SpecialChar       guifg=#D06020 guibg=NONE gui=bold
hi String            guifg=#D06020 guibg=NONE
hi Number            guifg=#D32000 guibg=NONE
hi Float             guifg=#D32000 guibg=NONE
...
hi Namespace         guifg=#8E9DA0 guibg=NONE gui=italic cterm=italic

hi Enumeration       guifg=#8040B0 guibg=NONE gui=bold
hi Enumerator        guifg=#108050 guibg=NONE gui=italic cterm=italic
...
if &t_Co > 255
  ...
  hi Boolean                   ctermfg=93   ctermbg=NONE cterm=italic

...
hi Namespace         guifg=#8E9DA0 guibg=NONE gui=italic ctermfg=66  ctermbg=NONE cterm=italic

hi Enumeration       guifg=#8040B0 guibg=NONE gui=bold   ctermfg=97  ctermbg=NONE cterm=bold  

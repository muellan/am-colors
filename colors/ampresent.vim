...
hi Visual            guifg=NONE    guibg=#A0E5FF
...
hi Tag               guifg=#0030F0               gui=italic cterm=italic
...
hi ComplMatchIns     guifg=#FFFFFF guibg=#404040

hi Pmenu             guifg=#000000 guibg=#D0D0CA
hi PmenuSel          guifg=#FFFFFF guibg=#404035 gui=bold
hi PmenuSbar                       guibg=#707065
hi PmenuThumb        guifg=#404035 guibg=#404040
hi PmenuMatch        guifg=#FFFFFF guibg=#404040 
hi PmenuMatchSel     guifg=#FFFFFF guibg=#404040  
...
" plugins {{{
"--------------------------------------------------------------------
hi CleverF     guifg=#FFFFFF guibg=#D000C0 gui=bold
...
hi SignatureMarkerText guifg=#FFFFFF guibg=#005000 gui=bold
...
hi NeoDbgBreakPoint      guifg=#FFFFFF guibg=#B03030 
hi NeoDbgDisabledBreak   guifg=NONE    guibg=#F5D8C8
...
hi GitGutterAddLineNr          guibg=#D8F5C8
hi GitGutterChangeLineNr       guibg=#F5F0C8
hi GitGutterChangeDeleteLineNr guibg=#F5E0C8
hi GitGutterDeleteLineNr       guibg=#F5D8C8
...
hi VM_Extend  guifg=NONE     guibg=#E0D0FF  gui=NONE
hi VM_Cursor  guifg=#000000  guibg=#B0A0FF  gui=NONE
hi VM_Mono    guifg=#000000  guibg=#60A0F0  gui=NONE
hi VM_Insert  guifg=#000000  guibg=#FDB01F  gui=NONE
...
hi Enumerator        guifg=#6020A0 guibg=NONE gui=italic cterm=italic
hi Attribute         guifg=#0090D0 guibg=NONE gui=italic cterm=italic
...
if &t_Co > 255
  ...
  hi Boolean                   ctermfg=27   ctermbg=NONE cterm=italic
  ...
  hi DiffText                               ctermbg=15   cterm=bold,italic
